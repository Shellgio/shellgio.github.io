---
date: '2026-06-14T12:13:43+01:00'
draft: false
title: 'Scheduled scans are coming to AV policies in Defender for Endpoint on Linux'
author: 'Shellgio'
categories:
...
- Linux
- Antivirus
description: 'Microsoft Defender for Linux now offers centrally managed scheduled antivirus scans, available in public preview. This feature allows security teams to configure flexible, consistent scans across Linux environments, enhancing threat detection and compliance.'
